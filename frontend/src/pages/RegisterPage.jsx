    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'linear-gradient(135deg, #0f3460 0%, #1a5490 100%)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', padding: '4rem', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          <h1 style={{ fontSize: '3.5rem', fontWeight: 700, marginBottom: '1rem' }}>Créer un compte 🚀</h1>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem', maxWidth: '500px', color: 'rgba(255, 255, 255, 0.9)' }}>
            Rejoignez notre plateforme LeadProdos et commencez à optimiser votre prospection dès aujourd'hui.
          </p>
          <button
            type="button"
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '4rem', overflowY: 'auto' }}>
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '1.875rem', color: '#0f3460', fontWeight: 700, marginBottom: '0.5rem' }}>S'inscrire</h2>
            <p style={{ color: '#6b7280', fontSize: '0.95rem' }}>Créez votre compte en quelques étapes</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <label style={{ fontSize: '0.875rem', fontWeight: 600, color: '#374151' }}>NOM D'UTILISATEUR</label>
            ...
            <div className="form-group">
              <label style={{ fontSize: '0.875rem', fontWeight: 600, color: '#374151' }}>ADRESSE E-MAIL</label>
              <div style={{ position: 'relative' }}>
                <span style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', fontSize: '1.2rem', zIndex: 1 }}>📧</span>
                <input
                  type="email"
            ...
            <div className="form-group">
              <label style={{ fontSize: '0.875rem', fontWeight: 600, color: '#374151' }}>CONFIRMER LE MOT DE PASSE</label>
              <div style={{ position: 'relative' }}>
                <span style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', fontSize: '1.2rem', zIndex: 1 }}>✅</span>
                <input
